...
class GraphicsObject_SkinShapeDefoLit :public GraphicsObject
{
public:

	GraphicsObject_SkinShapeDefoLit(Model *model, ShaderObject *pShaderObj, TextureName name, Vect &LightColor, Vect&LightPos, bool transparent = false);
