...
void PyramidModel::privCreateVAO(const char * const packageName, const char * const modelName)
{

	UNUSED_VAR(packageName);

	privCreateVAO(modelName);
...
void PyramidModel::privCreateVAO(const char * const modelFileName)
{
	...
	/*was a hack to get going moved to pose done properly now
