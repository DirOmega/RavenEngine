...
GraphicsObject_SkinFT::GraphicsObject_SkinFT(Model *model, ShaderObject *_pShaderObj, TextureName name)
...
void GraphicsObject_SkinFT::SetState()
{
...
void GraphicsObject_SkinFT::SetDataGPU()
{
	// use this shader
...
void GraphicsObject_SkinFT::Draw()
{
	// draw
...
void GraphicsObject_SkinFT::RestoreState()
{
	glEnable(GL_CULL_FACE);
	glFrontFace(GL_CW);
}
